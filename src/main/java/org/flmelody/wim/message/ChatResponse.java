...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ChatResponseOuterClass.internal_static_ChatResponse_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ChatResponseOuterClass.internal_static_ChatResponse_fieldAccessorTable
   ...
   */
  @Override public int getChatStatusValue() {
    return chatStatus_;
  }
  /**
   * <pre>
   ...
   */
  @Override public ChatStatus getChatStatus() {
    @SuppressWarnings("deprecation")
    ChatStatus result = ChatStatus.valueOf(chatStatus_);
    return result == null ? ChatStatus.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (chatStatus_ != ChatStatus.OK.getNumber()) {
  ...
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setChatStatus(ChatStatus value) {
      if (value == null) {
        throw new NullPointerException();
      }
